...
const HOME_FAQS: FAQ[] = [
  {
    ...
    answer: 'تختلف تكلفة تفصيل الركنة حسب نوع القماش والخامات المستخدمة والحجم. في الأشقاء نقدم أسعار تنافسية تبدأ من أسعار مناسبة جداً. اتصل بنا على 01105001387 للحصول على معاينة مجانية وعرض سعر.',
  },
  {
